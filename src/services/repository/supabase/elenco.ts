...
function paraTime(linha: Record<string, unknown>): Team {
  ...
  return {
    ...
    homeFieldLocationUrl: textoOuNulo(linha.home_field_location_url),
    defaultPixKey: textoOuNulo(linha.default_pix_key),
    defaultPaymentResponsibleName: textoOuNulo(linha.default_payment_responsible_name),
    defaultMatchWeekday:
      linha.default_match_weekday == null ? null : Number(linha.default_match_weekday),
    defaultAttendanceStatus:
      linha.default_attendance_status === 'absent' ? 'absent' : 'pending',
...
function mudancasDoTime(input: Record<string, unknown>): Record<string, unknown> {
  const mapa: Record<string, string> = {
    ...
    homeFieldLocationUrl: 'home_field_location_url',
    defaultPixKey: 'default_pix_key',
    defaultPaymentResponsibleName: 'default_payment_responsible_name',
    defaultMatchWeekday: 'default_match_weekday',
